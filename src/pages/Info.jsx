            ...
            <div className="content">
                ...
                <div className="section-1">
                    ...
                    <div className="button-group">
                        <a className="k-button k-primary" href="https://www.telerik.com/kendo-react-ui/#pricing">
                            {localizationService.toLanguageString('custom.buyNow')}
                        </a>
                        <a className="k-button k-ghost" href="https://www.telerik.com/download-login-v2-kendo-react-ui">
